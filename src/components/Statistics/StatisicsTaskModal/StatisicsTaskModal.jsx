import css from './StatisicsTaskModal.module.css';

import React, { useEffect } from 'react';
import { RiCloseFill } from 'react-icons/ri';
import { BiArchiveIn, BiArchiveOut, BiTask } from 'react-icons/bi';
import { getStatisticksTask } from 'redux/statisticsTaskSLice/statistics-selectors';
import { useSelector } from 'react-redux';
import { createPortal } from 'react-dom';

const modalRoot = document.querySelector('#modal-tasks');

export const StatisicsTaskModal = ({
  onBackdropClick,
  onCloseModal,
  onUnArchived,
  onUnArchivedTaskAll,
}) => {
  const notes = useSelector(getStatisticksTask);
      ...
      <div className={css.wrapper}>
        ...
        <div className={css.headerContainer}>
          <ul className={css.headerList}>
            ...
            <li className={css.headerItem}>
              <div>
                <button className={css.headerBtn} onClick={onUnArchivedTaskAll}>
                  <BiArchiveOut
